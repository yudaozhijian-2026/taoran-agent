...
POLICY_VERSION = "TAORAN-POST-REVIEW-20260921-EVIDENCE-BOUNDARY-V2"
...
POLICY = RECORD_GUIDANCE + (
    ...
    "客户共识单独通过customer_consensus_met判断；下一步最终判定仍包含日期、行动内容及适用的客户确认要求。"
    "商机客户意见表达使用next_contact_policy.feedback_guidance，不在意见中提出跨期、固定间隔或日期先后限制，评分程序仍保持原日期条件。"
