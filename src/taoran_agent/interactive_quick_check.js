...
const currentPolicy = 'front-v46-goal-boundary-v14-20260922';
const twoStageMode = typeof frontPolicy === 'string'
  && ['front-v46-two-stage-validated-modules-v8-20260918', previousSharedLedgerPolicy, previousAdvicePolicy, sharedLedgerPolicy, currentPolicy].includes(frontPolicy);
const adviceStageStatusText = twoStageMode ? '本次拜访分析已生成，正在生成AI改善建议…' : finalWaitingText;
const finalStreamMode = typeof frontPolicy === 'string' && ['front-v46-final-analysis-stream-v1-20260917','front-v46-final-analysis-typewriter-v1-20260917','front-v46-final-analysis-typewriter-v2-20260917','front-v46-taoran-advice-v3-20260917','front-v46-taoran-advice-v4-20260917','front-v46-taoran-advice-v5-20260918','front-v46-taoran-advice-v6-20260918','front-v46-validated-module-typewriter-v7-20260918','front-v46-two-stage-validated-modules-v8-20260918',previousSharedLedgerPolicy,previousAdvicePolicy,sharedLedgerPolicy, currentPolicy].includes(frontPolicy);
const typewriterMode = typeof frontPolicy === 'string' && ['front-v46-final-analysis-typewriter-v1-20260917','front-v46-final-analysis-typewriter-v2-20260917','front-v46-taoran-advice-v3-20260917','front-v46-taoran-advice-v4-20260917','front-v46-taoran-advice-v5-20260918','front-v46-taoran-advice-v6-20260918','front-v46-validated-module-typewriter-v7-20260918','front-v46-two-stage-validated-modules-v8-20260918',previousSharedLedgerPolicy,previousAdvicePolicy,sharedLedgerPolicy, currentPolicy].includes(frontPolicy);
const suggestionStreamMode = typeof frontPolicy === 'string' && ['front-v46-taoran-advice-v4-20260917','front-v46-taoran-advice-v5-20260918','front-v46-taoran-advice-v6-20260918','front-v46-validated-module-typewriter-v7-20260918','front-v46-two-stage-validated-modules-v8-20260918',previousSharedLedgerPolicy,previousAdvicePolicy,sharedLedgerPolicy, currentPolicy].includes(frontPolicy);
