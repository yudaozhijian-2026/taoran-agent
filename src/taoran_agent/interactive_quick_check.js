...
const sharedLedgerPolicy = 'front-v46-shared-ledger-joint-check-v9-20260918';
const twoStageMode = typeof frontPolicy === 'string'
  && ['front-v46-two-stage-validated-modules-v8-20260918', sharedLedgerPolicy].includes(frontPolicy);
const adviceStageStatusText = twoStageMode ? '本次拜访分析已生成，正在生成AI改善建议…' : finalWaitingText;
const finalStreamMode = typeof frontPolicy === 'string' && ['front-v46-final-analysis-stream-v1-20260917','front-v46-final-analysis-typewriter-v1-20260917','front-v46-final-analysis-typewriter-v2-20260917','front-v46-taoran-advice-v3-20260917','front-v46-taoran-advice-v4-20260917','front-v46-taoran-advice-v5-20260918','front-v46-taoran-advice-v6-20260918','front-v46-validated-module-typewriter-v7-20260918','front-v46-two-stage-validated-modules-v8-20260918',sharedLedgerPolicy].includes(frontPolicy);
const typewriterMode = typeof frontPolicy === 'string' && ['front-v46-final-analysis-typewriter-v1-20260917','front-v46-final-analysis-typewriter-v2-20260917','front-v46-taoran-advice-v3-20260917','front-v46-taoran-advice-v4-20260917','front-v46-taoran-advice-v5-20260918','front-v46-taoran-advice-v6-20260918','front-v46-validated-module-typewriter-v7-20260918','front-v46-two-stage-validated-modules-v8-20260918',sharedLedgerPolicy].includes(frontPolicy);
const suggestionStreamMode = typeof frontPolicy === 'string' && ['front-v46-taoran-advice-v4-20260917','front-v46-taoran-advice-v5-20260918','front-v46-taoran-advice-v6-20260918','front-v46-validated-module-typewriter-v7-20260918','front-v46-two-stage-validated-modules-v8-20260918',sharedLedgerPolicy].includes(frontPolicy);
