...
VERSION = "0.27.11rc1-manual-saved-20260908"
OLD = "0.27.10rc2-live-preview-20260908-side"
EXPECTED_IMAGE = "sha256:5a238291750fdec5998ddf078503827e39394d008fb86becf7ab74ef8deb346a"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "2df40f3a30f24ec4eb50143f9dfdb04d8aacd19d"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.10rc2"
        ...
        h = health()
        assert h["release_version"] == "0.27.11rc1" and h["prewarm"]["status"] == "ready"
