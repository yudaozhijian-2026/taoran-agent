...
OUT = ROOT / "dist/contact-facts-release"
OUT.mkdir(parents=True, exist_ok=True)
BASELINE = "9bb0f88d88a788ad5e7967eb4cde32a60d395ad2"
...
shutil.copy2(ROOT / "deploy/release_contact_facts.py", OUT / "release.py")
shutil.copy2(ROOT / "dist/dsm_taoran_agent-1.0.5-py3-none-any.whl", OUT)
(OUT / "Dockerfile.release").write_text("""FROM dsm-taoran-v2:1.0.4-contact-policy-20260914
USER root
WORKDIR /app
COPY dsm_taoran_agent-1.0.5-py3-none-any.whl /tmp/package.whl
RUN mv /tmp/package.whl /tmp/dsm_taoran_agent-1.0.5-py3-none-any.whl && uv pip install --python /app/.venv/bin/python --no-deps --no-index /tmp/dsm_taoran_agent-1.0.5-py3-none-any.whl
COPY src /app/src
COPY pyproject.toml uv.lock /app/
ARG GIT_COMMIT
LABEL org.opencontainers.image.revision=$GIT_COMMIT
LABEL top.yudaozhijian.taoran.release="1.0.5-contact-facts-20260914"
USER 10001:10001
""")
...
assert taoran_agent.__version__ == '1.0.5'
