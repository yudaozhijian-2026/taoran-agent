"""TAORAN V4.7 formal release guard; run on the server with preflight/switch/verify.
...
VERSION = "0.27.5rc2-v47-20260907"
OLD = "0.27.5rc1-v47-20260907"
EXPECTED_IMAGE = "sha256:4c2659960feac9e3efad48dfb8010fd246e208e1073bea81b45d5062162cc7c8"
...
def main(mode):
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.5rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.5rc2" and h["prewarm"]["status"] == "ready"
