...
VERSION = "0.27.12rc1-saved-preview-20260908"
OLD = "0.27.11rc1-manual-saved-20260908"
EXPECTED_IMAGE = "sha256:b7993748beae4c40af6553bf76cf20445bae166dd4826ef4d7ab529fbe556fb1"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "ba6dedc8663d01c855f85486ffca96dbecc64539"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.11rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.12rc1" and h["prewarm"]["status"] == "ready"
