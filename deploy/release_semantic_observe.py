"""TAORAN frontend V4.6 restoration release guard; run on the server with preflight/switch/verify.
...
VERSION = "0.27.7rc1-semantic-observe-20260908"
OLD = "0.27.6rc1-front-v46-20260908"
EXPECTED_IMAGE = "sha256:631c840c47b92f8e7c1458a6a2b9b8b8747bcc1eae2ad62519090527d92a42ff"
...
def main(mode):
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.6rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.7rc1" and h["prewarm"]["status"] == "ready"
        ...
        assert added <= {"quick_check_recovery"} and all(db["counts"][k] == 0 for k in added), (
