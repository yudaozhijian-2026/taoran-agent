...
VERSION = "0.27.15rc1-chinese-feedback-20260908"
OLD = "0.27.14rc1-front-output-limits-20260908"
EXPECTED_IMAGE = "sha256:b744ee9d0b7a5ad983a87ce664c992d10218a50ccea58a06a66ed71565e06085"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "74f4a3bd16e211165a11fe12225589574a200af3"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.14rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.15rc1" and h["prewarm"]["status"] == "ready"
