"""Explicit 1.0.5 rollout, confined to the verified TAORAN container and database.
...
VERSION = '1.0.5-contact-facts-20260914'
OLD = '1.0.4-contact-policy-20260914'
EXPECTED_IMAGE = 'sha256:da9a302b158089d296a8d0744fd2cbde8a0748922999896e9f2def3f3d599c0a'
EXPECTED_REVISION = '9bb0f88d88a788ad5e7967eb4cde32a60d395ad2'
...
def expected_old():
    ...
    assert health()['release_version'] == '1.0.4'
    return c
...
def main(mode):
    ...
    if mode == 'preflight':
        ...
        assert h['release_version'] == '1.0.5' and h['prewarm']['status'] == 'ready'
        assert c['Config']['Labels']['org.opencontainers.image.revision'] == (RELEASE / 'git-commit.txt').read_text().strip()
        assert health('https://taoran.yudaozhijian.top')['release_version'] == '1.0.5'
        ...
        temporary = BASE / 'current.contact-facts-new'
