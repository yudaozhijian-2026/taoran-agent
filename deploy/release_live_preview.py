...
VERSION = "0.27.10rc2-live-preview-20260908-side"
OLD = "0.27.10rc1-content-cache-20260908-1520"
EXPECTED_IMAGE = "sha256:45a019bf38cdc1b3e3794ead9c71391d42354af160b332ae3f2889b04fb37caf"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "590ca37878a22f97de52d95a0467a78785b7b3b8"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.10rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.10rc2" and h["prewarm"]["status"] == "ready"
