...
VERSION = "0.27.17rc1-remove-background-observation-20260908"
OLD = "0.27.16rc2-observation-repair-20260908"
EXPECTED_IMAGE = "sha256:647a94f3cda2c70ec4cbc332af25db12bee9bd0cb3bda7a26225a6dfa749bd57"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "d35d7f86ef8d746eaec00327477590d7ca60fd92"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.16rc2"
        ...
        h = health()
        assert h["release_version"] == "0.27.17rc1" and h["prewarm"]["status"] == "ready"
