...
VERSION = "1.0.2-auto-update-20260909"
OLD = "1.0.1-return-edit-20260909"
EXPECTED_IMAGE = "sha256:f9348e5e64daa3469951575cb61d9a6d5dc63e609f099d8876aba5bf67877f75"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "bd6deb4ef749682d110eb666df41fda05760114e"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "1.0.1"
        ...
        h = health()
        assert h["release_version"] == "1.0.2" and h["prewarm"]["status"] == "ready"
