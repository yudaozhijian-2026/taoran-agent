...
def switch():
    ...
    subprocess.check_call([
        ...
        "--label", "org.opencontainers.image.version=1.0.6rc63",
    ...
    temporary = COMPOSE.with_suffix(".yaml.rc63-new")
...
def verify():
    ...
    assert internal["release_version"] == "1.0.6rc63"
    assert external["release_version"] == "1.0.6rc63"
