"""TAORAN popup display cleanup release guard; run on the server with preflight/switch/verify.
...
VERSION = "0.27.7rc2-ui-clean-20260908"
OLD = "0.27.7rc1-semantic-observe-20260908"
EXPECTED_IMAGE = "sha256:bbdfd6cb5b96ff9e78e002a977ef8b1ddc1ca26a076d79eff97c14f5ea6578bd"
...
def main(mode):
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.7rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.7rc2" and h["prewarm"]["status"] == "ready"
