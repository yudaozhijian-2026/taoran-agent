...
VERSION = "0.27.18rc1-suggestion-contract-20260908"
OLD = "0.27.17rc1-remove-background-observation-20260908"
EXPECTED_IMAGE = "sha256:b0065bf34319e2782efb2a6c8e41812a1818dd8bfe03647dafd24d98e5407baa"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "71b18b1270802f5a5dca6ac8e6fb2a475b46d521"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.17rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.18rc1" and h["prewarm"]["status"] == "ready"
        ...
        assert added <= {"quick_check_recovery", "semantic_observation_jobs"} and all(db["counts"][k] == 0 for k in added), (
