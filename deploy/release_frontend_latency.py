...
VERSION = "0.27.16rc1-frontend-latency-20260908"
OLD = "0.27.15rc1-chinese-feedback-20260908"
EXPECTED_IMAGE = "sha256:83b70af134a6a2af8146c6a60e9cc3017c28316f4cb3628f5224a0b14033c1a8"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "6a0407f193c152b0f0883efb56c3c37a0d68fbc4"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.15rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.16rc1" and h["prewarm"]["status"] == "ready"
