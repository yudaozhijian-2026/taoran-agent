...
VERSION = "0.27.9rc1-feedback-complete-20260908-1420"
OLD = "0.27.8rc2-reliable-flow-20260908-1315"
EXPECTED_IMAGE = "sha256:b20e6b50f84e035b88173858b7722530dcf87e20f7740ca8c239332aedb13cff"
...
def main(mode):
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.8rc2"
        ...
        h = health()
        assert h["release_version"] == "0.27.9rc1" and h["prewarm"]["status"] == "ready"
