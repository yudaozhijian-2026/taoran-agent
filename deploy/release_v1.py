...
VERSION = "1.0.0-taoran-v1-20260909"
OLD = "0.27.20rc1-local-repair-20260909"
EXPECTED_IMAGE = "sha256:bce42ca4c317f5dfbda17260f60b87aa3a4e3c97e16d0f9b22ca9dbd62835dba"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "c82aa4843b18a5a27607e2a08845a61dda02f70e"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.20rc1"
        ...
        h = health()
        assert h["release_version"] == "1.0.0" and h["prewarm"]["status"] == "ready"
