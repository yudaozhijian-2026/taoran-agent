...
VERSION = "0.27.16rc2-observation-repair-20260908"
OLD = "0.27.16rc1-frontend-latency-20260908"
EXPECTED_IMAGE = "sha256:30e76e9bff9a5bb600ee75919f4a94ae910deb9346d549350bb262bfd23178f0"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "c5577cd2fbe5f858799e03ffdaee786dc1fd5f90"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.16rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.16rc2" and h["prewarm"]["status"] == "ready"
