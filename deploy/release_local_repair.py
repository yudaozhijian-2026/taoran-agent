...
VERSION = "0.27.20rc1-local-repair-20260909"
OLD = "0.27.19rc1-ui-feishu-20260908"
EXPECTED_IMAGE = "sha256:1ba5a1247a9467254cd5c777d995ed0c14af99b02fdc8067c8dbb9ae7e1fa0e2"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "cf087bc8926d73b1fb2c81f0ff27acfbe7bedd0e"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.19rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.20rc1" and h["prewarm"]["status"] == "ready"
