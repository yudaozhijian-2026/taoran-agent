...
VERSION = "0.27.14rc1-front-output-limits-20260908"
OLD = "0.27.13rc2-transport-probe-20260908"
EXPECTED_IMAGE = "sha256:acfaac0b19f25762233f5d333107bd15277849678b79d1f359f4dc46cc8fe8ae"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "cffd734dd53a7348d188b6475dc974833877759a"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.13rc2"
        ...
        h = health()
        assert h["release_version"] == "0.27.14rc1" and h["prewarm"]["status"] == "ready"
