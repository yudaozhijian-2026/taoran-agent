"""TAORAN popup self-service release guard; run on the server with preflight/switch/verify.
...
VERSION = "0.27.7rc3-popup-selfservice-20260908"
OLD = "0.27.7rc2-ui-clean-20260908"
EXPECTED_IMAGE = "sha256:8c854474d28e24f50633717995d7bc4c1c0b2f3cc87b1805d18ba8813be47c7a"
...
def main(mode):
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.7rc2"
        ...
        h = health()
        assert h["release_version"] == "0.27.7rc3" and h["prewarm"]["status"] == "ready"
