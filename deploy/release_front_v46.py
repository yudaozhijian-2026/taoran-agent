...
VERSION = "0.27.6rc1-front-v46-20260908"
OLD = "0.27.5rc2-v47-20260907"
EXPECTED_IMAGE = "sha256:34893db94ac29715b63f0531bb1cf1bb1cf93778a3c4a9632c3c9809b4636df0"
...
def main(mode):
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.5rc2"
        ...
        h = health()
        assert h["release_version"] == "0.27.6rc1" and h["prewarm"]["status"] == "ready"
