...
VERSION = "0.27.10rc1-content-cache-20260908-1520"
OLD = "0.27.9rc1-feedback-complete-20260908-1420"
EXPECTED_IMAGE = "sha256:8fbd5d048db27bbde6b5daed86d8b92e328b1ba0b907ea1ba15567986e5c7241"
...
def main(mode):
    ...
    if mode in {"preflight", "switch"}:
        assert inspect()["Config"]["Labels"].get("org.opencontainers.image.revision") == (
            "73a16c616debdcafa5d5f22a51bcff46c91a7c41"
    ...
    if mode == "preflight":
        ...
        assert health()["release_version"] == "0.27.9rc1"
        ...
        h = health()
        assert h["release_version"] == "0.27.10rc1" and h["prewarm"]["status"] == "ready"
